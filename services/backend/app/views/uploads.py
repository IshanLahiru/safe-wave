...
async def get_user_documents(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR, detail="Failed to fetch documents"
        )
...
async def delete_document(
    ...
    try:
        ...
        logger.info(
            f"Document deleted successfully: {document.filename} for user {current_user.id}"
        )
