...
class VoskTranscriptionService:
        ...
        try:
            ...
            if audio_file_path.lower().endswith(".wav"):
                ...
                try:
                    ...
                    logger.info(
                        f"File {audio_file_path} has .wav extension but is not a valid WAV file"
                    )
            ...
            try:
                ...
                try:
                    ...
                    raise Exception(
                        f"Audio conversion failed with both ffmpeg and soundfile: {ffmpeg_error}, {sf_error}"
                    )
    ...
    def get_model_info(self) -> dict:
        ...
        if not self.model:
            return {"status": "not_loaded", "message": "No Vosk model loaded"}
