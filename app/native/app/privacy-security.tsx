      ...
      >
        ...
        <ModernCard variant='surface' style={styles.section}>
          ...
          <ThemedText type='body' variant='muted' style={styles.securityInfo}>
            Safe Wave takes your privacy seriously. We use end-to-end encryption for all sensitive
            data, implement secure authentication protocols, and never share your personal
