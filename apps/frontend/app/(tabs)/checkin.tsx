        ...
        >
          <ModernCard style={styles.cardContent}>
            <View style={styles.recordingHeader}>
              ...
              <TouchableOpacity
                style={[styles.playButton, recording.isPlaying && styles.playingButton]}
                onPress={e => {
                  e.stopPropagation();
                  handlePlayPress();
                }}
      ...
      if (isWeb) {
        ...
        try {
          ...
          if (recording.file_path && !recording.uri.startsWith('http')) {
            ...
            const baseUrl = getBackendUrl(); // Get backend URL from config
        ...
        <View style={styles.recordingStatus}>
          {isRecording ? (
            ...
            <>
              ...
              <ThemedText style={styles.recordingHint}>Tap the microphone to start</ThemedText>
            </>
          )}
        </View>
      </Animated.View>
