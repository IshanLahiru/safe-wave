...
export default function OnboardingQuestionnaire() {
    ...
    const handleFileUpload = async (questionId: string) => {
        try {
            ...
            // Upload to backend
            const response = await fetch(`${getBackendUrl()}/documents/onboarding-upload`, {
                method: 'POST',
                headers: {
                                ...
                                return (
                                    ...
                                    >
                                        <ThemedText style={[
                                            ...
                                            { color: isSelected ? 'white' : scaleColor }
                                        ]}>
                                            {value}
                                        </ThemedText>
                                        {isSelected && (
                                            <ThemedText style={styles.scaleButtonLabel}>
                                                {scaleLabel}
                                            </ThemedText>
                                        )}
                                    </TouchableOpacity>
                    ...
                    <View style={styles.fileUploadContainer}>
                        ...
                        {!uploadedFile ? (
                            ...
                            <View style={styles.uploadedFileContainer}>
                                ...
                                <ThemedText style={styles.uploadedFileName}>
                                    {uploadedFile.name}
                                </ThemedText>
                                <TouchableOpacity
